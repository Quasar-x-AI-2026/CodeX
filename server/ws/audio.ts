...
// Initialize the relay service (Use env for API key)
...
export function handle(ws: WebSocket, payload: unknown) {
    try {
        ...
        switch (p.type) {
            ...
            case "chunk":
                // Chunks are no longer used as we pass the full transcript at the end.
                // This case is kept for compatibility with existing client calls during transition.
                break;
